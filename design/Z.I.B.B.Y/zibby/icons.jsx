...
const Icon = ({ name, size = 18, stroke = 1.6, style }) => {
  ...
  const paths = {
    grid: <><rect height="7" width="7" x="3" y="3" {...p} /><rect height="7" width="7" x="14" y="3" {...p} /><rect height="7" width="7" x="3" y="14" {...p} /><rect height="7" width="7" x="14" y="14" {...p} /></>,
    ...
    film: <><rect height="16" rx="2" width="18" x="3" y="4" {...p} /><path d="M7 4v16M17 4v16M3 9h4M17 9h4M3 15h4M17 15h4" {...p} /></>,
    server: <><rect height="7" rx="1.5" width="18" x="3" y="4" {...p} /><rect height="7" rx="1.5" width="18" x="3" y="13" {...p} /><path d="M7 7.5h.01M7 16.5h.01" {...p} /></>,
    ...
    stop: <rect height="12" rx="2" width="12" x="6" y="6" {...p} />,
    plus: <path d="M12 5v14M5 12h14" {...p} />,
    chevron: <path d="M9 6l6 6-6 6" {...p} />,
    dots: <><circle cx="5" cy="12" fill="currentColor" r="1.3" stroke="none" /><circle cx="12" cy="12" fill="currentColor" r="1.3" stroke="none" /><circle cx="19" cy="12" fill="currentColor" r="1.3" stroke="none" /></>,
    ...
    bot: <><rect height="11" rx="2.5" width="16" x="4" y="8" {...p} /><path d="M12 4v4M9 13h.01M15 13h.01M9 8h6" {...p} /><circle cx="12" cy="3.5" r="1.3" {...p} /></>,
    flow: <><rect height="5" rx="1" width="6" x="3" y="4" {...p} /><rect height="5" rx="1" width="6" x="15" y="4" {...p} /><rect height="5" rx="1" width="6" x="9" y="15" {...p} /><path d="M6 9v3a2 2 0 0 0 2 2h1M18 9v3a2 2 0 0 1-2 2h-1" {...p} /></>,
    ...
    pause: <><rect height="14" rx="1" width="3.5" x="7" y="5" {...p} /><rect height="14" rx="1" width="3.5" x="13.5" y="5" {...p} /></>,
    ...
    image: <><rect height="16" rx="2" width="18" x="3" y="4" {...p} /><circle cx="8.5" cy="9.5" r="1.6" {...p} /><path d="M21 16l-5.5-5.5a2 2 0 0 0-2.8 0L4 19" {...p} /></>,
    upload: <><path d="M12 16V4M7 8l5-5 5 5" {...p} /><path d="M4 16v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3" {...p} /></>,
  };
  return <svg height={size} style={{ display: 'block', flex: '0 0 auto', ...style }} viewBox="0 0 24 24" width={size}>{paths[name] || null}</svg>;
};

// ZIBBY top-hat mark (cylindr) — small butler glyph
const ZibbyMark = ({ size = 22, color = '#e6edf3' }) => (
  <svg height={size} style={{ display: 'block' }} viewBox="0 0 32 32" width={size}>
    <ellipse cx="16" cy="25" fill={color} opacity="0.18" rx="12" ry="2.4" />
    <path d="M9 24h14" stroke={color} strokeLinecap="round" strokeWidth="2" />
    <path d="M11 24V11a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v13" fill="none" stroke={color} strokeLinejoin="round" strokeWidth="2" />
  ...
  if (src) {
    return (
      <div style={{
        ...
        <img alt="" src={src} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', ...imgStyle }} />
      </div>
    );
  }
  return (
