...
const Z = {
  ...
  // context accents
  home: '#f0b429',     // amber
  homeDim: 'rgba(240,180,41,0.16)',
  work: '#5b8def',     // blue
  workDim: 'rgba(91,141,239,0.16)',
  // status
  ok: '#39d98a',
  warn: '#f0b429',
  bad: '#ff6b6b',
...
const AGENTS_BASE = [
  // WORK
  { id:'architect', name:'Architekt', glyph:'compass', role:'Navrhne řešení a rozepíše plán do design.md', model:'opus', thinking:'high', tools:['read','web','write'], ctx:'work', category:'Vývoj', state:'idle', enabled:true, runs:64, file:'~/zibby/agents/architect.agent.md' },
  { id:'coder', name:'Kodér', glyph:'code', role:'Implementuje podle design.md v izolované branchi', model:'sonnet', thinking:'medium', tools:['read','write','bash','git'], ctx:'work', category:'Vývoj', state:'pipeline', enabled:true, runs:212, file:'~/zibby/agents/coder.agent.md' },
  { id:'tester', name:'Tester', glyph:'flask', role:'Spustí testy, vrací report a vrací práci zpět', model:'sonnet', thinking:'medium', tools:['read','bash','git'], ctx:'work', category:'Kvalita', state:'pipeline', enabled:true, runs:198, file:'~/zibby/agents/tester.agent.md' },
  { id:'reviewer', name:'Reviewer', glyph:'check', role:'Pre-review diffu před návrhem na push', model:'opus', thinking:'high', tools:['read','git'], ctx:'work', category:'Kvalita', state:'idle', enabled:true, runs:47, file:'~/zibby/agents/reviewer.agent.md' },
  ...
  { id:'doc', name:'Dokumentátor', glyph:'doc', role:'Sepíše README a changelog z výsledné branche', model:'sonnet', thinking:'low', tools:['read','write'], ctx:'work', category:'Dokumentace', state:'idle', enabled:true, runs:29, file:'~/zibby/agents/doc.agent.md' },
  // HOME
