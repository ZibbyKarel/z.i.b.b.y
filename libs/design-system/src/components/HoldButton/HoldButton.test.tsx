...
describe("HoldButton", () => {
  ...
  it("renders the idle label", () => {
    ...
    expect(screen.getByTestId(HoldButtonTestId.Root)).toHaveAccessibleName(
      "Podržet pro schválení",
    )
  })
  ...
  it("confirms after a full hold and switches to the done label", () => {
    ...
    render(
      <HoldButton doneLabel="Schváleno" label="Podržet" onConfirm={onConfirm} />,
    )
