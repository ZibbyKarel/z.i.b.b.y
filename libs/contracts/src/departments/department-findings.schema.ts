...
/**
 * NS2 F5a — one persisted fingerprint set per scan key (`"sec"`,
 * `"qa"`…). {@link apps/api/src/departments/department-findings.store.ts}
 ...
 *
 * Internal — persisted to disk (`DEPARTMENT_FINDINGS_DIR/<key>.json`) but never
