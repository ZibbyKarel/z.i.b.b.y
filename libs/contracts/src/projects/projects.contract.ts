...
export const projectsContract = c.router(
  {
    ...
    getProjectProfile: {
      ...
      summary: "Get the project profile (identity, autonomy policy, daily rhythm)",
    },
    putProjectProfile: {
      method: "PUT",
      path: "/projects/:id/profile",
      ...
      summary: "Replace the project profile; 422 if the autonomy policy would relax the floor",
    },
    listProjectPeople: {
      method: "GET",
      path: "/projects/:id/people",
      pathParams: z.object({ id: ProjectIdSchema }),
      responses: { 200: z.array(PersonSchema), 404: ErrorSchema },
    ...
    addProjectPerson: {
      ...
      pathParams: z.object({ id: ProjectIdSchema }),
      body: PersonSchema,
      responses: { 201: ProjectProfileSchema, 404: ErrorSchema },
      summary: "Append a person to the project team",
    },
  },
