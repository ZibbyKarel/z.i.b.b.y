...
description: "Use this agent when auditing the site against WCAG 2.2 AA, testing the interactive isometric house scene and forms with a keyboard or screen reader, or reviewing any component for accessibility before it ships. Invoke after building or changing UI (especially the homepage house illustration, navigation, and the Web3Forms contact form) and before merging."
glyph: eye
model: sonnet
thinking: medium
