...
glyph: flask
desc: Systematic literature-review workflow for academic, biomedical, technical, and scientific topics, including search planning, source screening, synthesis, citation checks, and evidence logging.
category: Research
---

> _Zdroj: [affaan-m/ecc](https://github.com/affaan-m/ecc/blob/HEAD/skills/scientific-thinking-literature-review/SKILL.md) — MIT. Upraveno pro ZIBBY._
