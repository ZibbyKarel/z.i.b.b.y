...
glyph: server
desc: Backend architecture patterns, API design, database optimization, and server-side best practices for Node.js, Express, and Next.js API routes.
category: Coding & Delivery
---

> _Zdroj: [affaan-m/ecc](https://github.com/affaan-m/ecc/blob/HEAD/skills/backend-patterns/SKILL.md) — MIT. Upraveno pro ZIBBY._
