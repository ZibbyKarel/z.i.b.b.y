  ...
  return [
    ...
    },
    {
      ...
      args: [
        ...
        "--permission-mode", "dontAsk",
        "--allowedTools", "Read", "Bash",
        "--append-system-prompt", "You are a smoke-test agent. Follow the user's instruction exactly.",
        "--model", "haiku",
      ],
      check: (r) => r.stdout.includes(MARKER),
    },
    {
      ...
      args: [
        ...
        "--agents", JSON.stringify({
          "smoke-helper": { description: "A no-op helper for the smoke test", prompt: "Do nothing." },
        }),
        "--model", "haiku",
      ],
      check: (r) => r.stdout.includes(MARKER),
