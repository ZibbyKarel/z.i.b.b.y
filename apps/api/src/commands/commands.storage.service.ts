 ...
 */
@Injectable()
export class CommandsStorageService extends MarkdownEntityStore<Command> implements OnModuleInit {
  ...
  protected fromFrontmatter(
    ...
    if (typeof data["argument-hint"] === "string") candidate["argument-hint"] = data["argument-hint"]
