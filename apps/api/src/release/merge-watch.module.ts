...
/** Default merge-watch dir, anchored to `apps/api/data/release/merge-watch`. */
export function resolveMergeWatchDir(): string {
  return process.env.MERGE_WATCH_DIR ?? dataDir("release/merge-watch");
}
 ...
 * and `ReleaseModule` (`PostMergeWatchService` polls it) import this directly, and
