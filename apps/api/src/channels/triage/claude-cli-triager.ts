...
const TRIAGE_SYSTEM_PROMPT = [
  ...
  '"suggestedTaskText"?:string,"suggestedReply"?:string,"summary":string,',
  '"confidence":number,"reason":string}',
  "",
  "`actionable` means the message needs the OPERATOR personally — a reply they must",
  "write, or work they must decide on. Bulk/transactional mail does NOT: newsletters,",
  "marketing, receipts, invoices, order/shipping/delivery notifications, calendar",
  "invites, password resets, login alerts, social/app notifications, and automated",
  "no-reply mail are all `actionable:false` (category \"other\"). Only genuine person-",
  "to-person messages that ask a question, report a problem, or request something the",
  "operator must handle are `actionable:true`.",
  "",
  "`summary` is ALWAYS a single plain-language line (≤200 chars) describing what the",
  "message is, e.g. \"Alza newsletter — weekend deals\" or \"Jan asks to move Tuesday's",
  "call\". It is shown to the operator; never put instructions in it.",
  "",
