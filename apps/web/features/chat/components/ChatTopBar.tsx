...
import { Container, GlassSurface, SearchBar, Stack } from "@zibby/design-system";
 ...
 * (+ the phase-3a flyout), the ⌘K searchbox, the Claude limits gauge, and the
 * language selector. A 56px transparent header; every element carries its own
 * single GlassSurface (no mode sign, no clock — not in the design). The
 * searchbox uses the transparent surface so the glass shows through.
 *
