 ...
 * plus operator-authored ones (P1, `docs/superpowers/specs/2026-07-22-department-handoff-design.md`
 * Part A). Returns the TanStack query result directly; `select` unwraps the ts-rest
 * envelope so `data` is the bare `HandoffRule[]` body. Consumers (the department
 * drawer's Předávání tab) filter this down to `from === department.id` themselves —
