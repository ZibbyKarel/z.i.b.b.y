  ...
  switch (kind) {
    ...
    case "agent":
      return {
        ...
        fields: [
          { name: "name", label: t("forms.agent.nameLabel"), kind: "text", placeholder: t("forms.agent.namePlaceholder"), required: true },
    ...
    case "pipeline":
      return {
        ...
        fields: [
          { name: "name", label: t("forms.pipeline.nameLabel"), kind: "text", placeholder: t("forms.pipeline.namePlaceholder"), required: true },
          { name: "desc", label: t("forms.pipeline.descLabel"), kind: "textarea", placeholder: t("forms.pipeline.descPlaceholder") },
          { name: "budget", label: t("forms.pipeline.budgetLabel"), kind: "segmented", defaultValue: "25", options: [
            { value: "10", label: "$10" },
            { value: "25", label: "$25" },
            { value: "50", label: "$50" },
          ] },
