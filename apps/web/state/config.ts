 ...
 * `/commands`, `/mcp`, `/hooks` (F3 — `isFullscreenRoute`'s prefix match also
 * covers each section's `/[id]` detail route). F10 collapses this table
 * entirely once the HUD branch is deleted.
 */
