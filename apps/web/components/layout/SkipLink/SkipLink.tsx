 ...
 * landmark, skipping the immersive header band / topbar chrome. Layout
 * chrome, not a DS primitive — mounted once in `AppShell` (F10b,
 * `docs/plans/hud2chat-F10b-landmarks.md`), recovered verbatim from the
 * pre-F10 `MainLayout` era: the markup here was never HUD-specific, only the
 * mount point moved.
 */
