...
<!-- AUTO:META:START -->
_Generated: 2026-07-08T13:04:28.107Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 154 edges
- `Typography()` — 150 edges
- `apiClient` — 136 edges
- `selectApiResponseBody()` — 115 edges
- `renderWithProviders()` — 104 edges
- `Container()` — 101 edges
- `PipelineRunnerService` — 93 edges
- `LoggerService` — 91 edges
- `cn()` — 89 edges
- `IconName` — 88 edges
...
- index.ts (150 nodes)
- Stack (130 nodes)
- DetailScreen.tsx (125 nodes)
- pipeline-runner.service.ts (106 nodes)
- Card.tsx (106 nodes)
- RunDetail.tsx (100 nodes)
- index.ts (78 nodes)
- IconName (77 nodes)
- render.tsx (66 nodes)
