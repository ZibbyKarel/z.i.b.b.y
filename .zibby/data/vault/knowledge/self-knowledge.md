...
<!-- AUTO:META:START -->
_Generated: 2026-07-10T21:50:02.997Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 168 edges
- `Typography()` — 164 edges
- `apiClient` — 148 edges
- `selectApiResponseBody()` — 127 edges
- `renderWithProviders()` — 116 edges
- `Container()` — 105 edges
...
### Communities (672)
- MonitorEventStore (177 nodes)
- tasks.controller.ts (160 nodes)
- SkillFormFields.tsx (141 nodes)
- Stack (140 nodes)
- render.tsx (134 nodes)
- pipeline-runner.service.ts (127 nodes)
- IconName (108 nodes)
- api.ts (86 nodes)
- VaultService (73 nodes)
- RunDetail.tsx (70 nodes)
