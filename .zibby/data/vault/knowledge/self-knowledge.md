...
<!-- AUTO:META:START -->
_Generated: 2026-07-11T21:10:50.531Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 170 edges
- `Typography()` — 166 edges
- `apiClient` — 146 edges
- `selectApiResponseBody()` — 125 edges
- `renderWithProviders()` — 118 edges
- `Container()` — 107 edges
- `PipelineRunnerService` — 95 edges
- `IconName` — 91 edges
- `cn()` — 91 edges
- `LoggerService` — 89 edges

### Communities (682)
- tasks.controller.ts (280 nodes)
- IconName (147 nodes)
- pipeline-runner.service.ts (126 nodes)
- render.tsx (119 nodes)
- RunDetail.tsx (116 nodes)
- selectApiResponseBody (87 nodes)
- NoteEditorDialog.test.tsx (83 nodes)
- Stack (81 nodes)
- briefing-assembly.ts (79 nodes)
- VaultService (74 nodes)
