...
<!-- AUTO:META:START -->
_Generated: 2026-07-10T12:29:24.868Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 166 edges
- `Typography()` — 162 edges
- `apiClient` — 147 edges
- `selectApiResponseBody()` — 127 edges
- `renderWithProviders()` — 114 edges
- `Container()` — 105 edges
- `PipelineRunnerService` — 95 edges
- `LoggerService` — 93 edges
- `IconName` — 91 edges
- `cn()` — 91 edges

### Communities (694)
- cn (159 nodes)
- DetailScreen.tsx (152 nodes)
- Stack (100 nodes)
- RunDetail.tsx (97 nodes)
- Gap detection (M5) (91 nodes)
- pipeline-runner.service.ts (87 nodes)
- Agent (71 nodes)
- projects.storage.service.ts (70 nodes)
- ChatMessage (63 nodes)
- companies.storage.service.ts (63 nodes)
