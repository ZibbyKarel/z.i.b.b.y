...
<!-- AUTO:META:START -->
_Generated: 2026-07-11T21:55:00.977Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 171 edges
- `Typography()` — 167 edges
- `apiClient` — 146 edges
- `selectApiResponseBody()` — 125 edges
- `renderWithProviders()` — 119 edges
- `Container()` — 108 edges
...
### Communities (694)
- Gap detection (M5) (183 nodes)
- Stack (156 nodes)
- tasks.controller.ts (142 nodes)
- RunDetail.tsx (120 nodes)
- pipeline-runner.service.ts (114 nodes)
- IconName (108 nodes)
- ChatScreen.tsx (95 nodes)
- selectApiResponseBody (94 nodes)
- chain.schema.ts (79 nodes)
- Card.tsx (60 nodes)
