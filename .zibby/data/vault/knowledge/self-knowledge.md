...
<!-- AUTO:META:START -->
_Generated: 2026-07-10T16:51:34.029Z_
<!-- AUTO:META:END -->
...
### God nodes (10)
- `Stack()` — 167 edges
- `Typography()` — 163 edges
- `apiClient` — 148 edges
- `selectApiResponseBody()` — 127 edges
- `renderWithProviders()` — 115 edges
- `Container()` — 105 edges
...
### Communities (653)
- tasks.module.ts (133 nodes)
- task.ts (120 nodes)
- pipeline-runner.service.ts (119 nodes)
- IconName (118 nodes)
- companies.storage.service.ts (95 nodes)
- render.tsx (92 nodes)
- WorkspaceService (81 nodes)
- Stack (75 nodes)
- SkillFormFields.tsx (72 nodes)
- projects.storage.service.ts (67 nodes)
