...
_Generated: 2026-09-25T06:42:10.441Z_
...
- `renderWithProviders()` — 153 edges
- `LoggerService` — 145 edges
- `LoggerService` — 144 edges

### Communities (1149)

- tasks.controller.ts (684 nodes)
- index.ts (456 nodes)
- DesignSystemGenerator (346 nodes)
- README.md (319 nodes)
- Development Workflow (300 nodes)
- events.controller.ts (288 nodes)
- schedule.ts (273 nodes)
- monitor-watcher.service.test.ts (228 nodes)
- Agent (224 nodes)
- app.module.ts (221 nodes)
...
- Monitoring & Ops (`ops`) — Sledování kanálů, kalendáře a CI/CD na pravidelném heartbeatu.
