...
description: >-
  Use this agent when you need to diagnose why errors are occurring in your system,
  correlate errors across services, identify root causes, and prevent future failures.
glyph: search
model: sonnet
thinking: medium
tools:
