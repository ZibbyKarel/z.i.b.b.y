...
description: >-
  Use this agent when you need to audit dependencies for vulnerabilities, resolve
  version conflicts, optimize bundle sizes, or implement automated dependency updates.
glyph: link
model: haiku
thinking: low
tools:
