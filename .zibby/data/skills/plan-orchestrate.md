...
> _Zdroj: [affaan-m/ecc](https://github.com/affaan-m/ecc/blob/HEAD/skills/plan-orchestrate/SKILL.md) — MIT. Upraveno pro ZIBBY._
...
3. Resolve `--lang`. When `auto`, run a polyglot-aware detection:
   ...
   - `lang=unknown` is a security — it is **not** an agent name. Phase 2 rules 4 and 5 turn it into `code-reviewer` / `build-error-resolver` at chain composition time.
